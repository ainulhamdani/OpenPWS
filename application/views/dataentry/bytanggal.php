...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Data entry berdasarkan tanggal</h1>
                        ...
                        <div class="row">
                            <div class="col col-sm-3">
                                ...
                                <div class="list-group">
                                    ...
                                    foreach ($loc['children'] as $key => $child) {
                                        ?>
                                        <a href="<?=base_url()?>dataentry/bytanggal?t1=<?=$key?>" class="list-group-item list-group-item-action<?=$t1==$key?" active":""?>"><?=$this->loc->sanitizeLabel($child['label'])?></a>
                                        <?php
                                    }
                                    ?>
                                </div>
                            ...
                            <div class="col col-sm-3">
                                ...
                                <div class="list-group">
                                    ...
                                    foreach ($loc['children'][$t1]['children'] as $key => $child) {
                                        ?>
                                        <a href="<?=base_url()?>dataentry/bytanggal?t1=<?=$t1?>&t2=<?=$key?>" class="list-group-item list-group-item-action<?=$t2==$key?" active":""?>"><?=$this->loc->sanitizeLabel($child['label'])?></a>
                                        <?php
                                    }
                                    ?>
                                </div>
                        ...
                        <?php } if(isset($t2)&&isset($loc['children'][$t1]['children'][$t2]['children'])){?>
                            <div class="col col-sm-3">
                                ...
                                <div class="list-group">
                                    ...
                                    foreach ($loc['children'][$t1]['children'][$t2]['children'] as $key => $child) {
                                        ?>
                                       <a href="<?=base_url()?>dataentry/bytanggal?t1=<?=$t1?>&t2=<?=$t2?>&t3=<?=$key?>" class="list-group-item list-group-item-action<?=$t3==$key?" active":""?>"><?=$this->loc->sanitizeLabel($child['label'])?></a>
                                        <?php
                                    }
                                    ?>
                                </div>
                        ...
                        <?php } if(isset($t3)&&isset($loc['children'][$t1]['children'][$t2]['children'][$t3]['children'])){?>
                            <div class="col col-sm-3">
                                ...
                                <div class="list-group">
                                    ...
                                    foreach ($loc['children'][$t1]['children'][$t2]['children'][$t3]['children'] as $key => $child) {
                                        ?>
                                        <a href="<?=base_url()?>dataentry/bytanggal?t1=<?=$t1?>&t2=<?=$t2?>&t3=<?=$t3?>&t4=<?=$key?>" class="list-group-item list-group-item-action<?=$t4==$key?" active":""?>"><?=$this->loc->sanitizeLabel($child['label'])?></a>
                                        <?php
                                    }
                                    ?>
                                </div>
        ...
        <?php
            ...
            <div title="<?=$this->loc->getTagDesc($tag)?> <?=ucwords($this->loc->sanitizeLabel($value['label']))?>">
                    <div id="">
                        ...
                        <div id="<?=str_replace(' ', '_', $key);?>" align="center">
                        </div>
...
<script src="<?=base_url()?>vendor/highcharts/modules/data.js"></script>
<script src="<?=base_url()?>vendor/highcharts/modules/drilldown.js"></script>
